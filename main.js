...
var cheatClipFactor = 2;
function cheatClips(){
    clips = clips + (10 * cheatClipFactor);
    unusedClips = unusedClips + (10 * cheatClipFactor);
    cheatClipFactor = cheatClipFactor * 2;
    displayMessage("you just cheated");
    }

var cheatMoneyFactor = 2;
function cheatMoney(){
    funds = funds + (10 * cheatMoneyFactor);
    document.getElementById("funds").innerHTML = funds.toFixed(2);
    displayMessage("LIZA just cheated");
    cheatMoneyFactor = cheatMoneyFactor * 2;
    }
...
var cheatOpFactor = 2;
function cheatOps(){
    standardOps = standardOps + (10 * cheatOpFactor);
    displayMessage("you just cheated, Liza");
    cheatOpFactor = cheatOpFactor * 2;
    }

var cheatCreatFactor = 2;
function cheatCreat(){
    creativityOn = 1;
    creativity = creativity + (10 * cheatCreatFactor);
    displayMessage("Liza just cheated. Very creative!");
    cheatCreatFactor = cheatCreatFactor * 2;
    }
